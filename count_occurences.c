...
// Function to find the first or last occurence of a given number in
// a sorted integer array. If `searchFirst` is true, return the
// first occurence of the number; otherwise, return its last occurence.
...
int main(void)
{
    ...
    // pass value 1 for the first occurence
    int first = binarySearch(nums, n, target, 1);

    // pass value 0 for the last occurence
